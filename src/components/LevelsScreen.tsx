import { ArrowLeft, Lock, CheckCircle, Circle, Home } from 'lucide-react';
...
const categoryNames = { basic: 'Basic', intermediate: 'Intermediate', advanced: 'Advanced' };
...
const LevelsScreen = ({ language, category, getLevelProgress, onSelect, onBack, onHome }: LevelsScreenProps) => {
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Complete all {topics.length} levels — 20 questions each</p>
            </div>
          </div>
          {onHome && (
